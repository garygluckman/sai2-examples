...
// redis keys
const std::string JOINT_ANGLES_KEY = "sai2::examples::sensors::q";
const std::string JOINT_VELOCITIES_KEY = "sai2::examples::sensors::dq";
const std::string JOINT_TORQUES_COMMANDED_KEY = "sai2::examples::actuators::fgc";
...
// robot file
const std::string ROBOT_FILE = "resources/puma_modified.urdf";
